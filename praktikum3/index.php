...
<body>
    ...
    <div class="form-group row">
        ...
        <div class="custom-control custom-checkbox custom-control-inline">
            <input name="skills" id="skills_3" type="checkbox" required="required" class="custom-control-input" value="PHP"> 
            <label for="skills_3" class="custom-control-label">PHP</label>
        </div>
        <div class="custom-control custom-checkbox custom-control-inline">
            <input name="skills" id="skills_4" type="checkbox" required="required" class="custom-control-input" value="Python"> 
